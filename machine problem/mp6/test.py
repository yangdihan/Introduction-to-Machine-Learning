...
class DeepLearningTest(unittest.TestCase):
	...
	def test_sigmoidPrime(self):
		...
		d_sig_2 = s * (1 - s)
		self.assertAlmostEqual(d_sig_1[0],d_sig_2[0])
		self.assertAlmostEqual(d_sig_1[1],d_sig_2[1])
		self.assertAlmostEqual(d_sig_1[2],d_sig_2[2])
	...
	def test_forward(self):
		...
		sol_2 = NN.sigmoid(h)
		self.assertAlmostEqual(sol_1[0][0],sol_2[0][0])
		self.assertAlmostEqual(sol_1[1][0],sol_2[1][0])
		self.assertAlmostEqual(sol_1[2][0],sol_2[2][0])
